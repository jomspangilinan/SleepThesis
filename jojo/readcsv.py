...
peaks_fft_loc, _ = find_peaks(ir_vec)
peaks_mag=np.array(ir_vec)[peaks_fft_loc]
peaks_actual_loc = np.array(t_vec)[peaks_fft_loc]
...
plt1 = ax1.plot(t_vec,ir_vec,label='IR',color='#CE445D',linewidth=1)
